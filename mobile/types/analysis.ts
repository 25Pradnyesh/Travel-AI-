/**
 * Travel AI — Mobile Analysis Data Contracts
 *
 * Directly mirrors the FastAPI engine response schemas from
 * engine/domain/schemas/responses.py and response_builder.py.
 */
